...
public class UseCaseFetchAllPosts : IUseCaseQuery<IEnumerable<DtoOutputPost>>
{
    ...
    public UseCaseFetchAllPosts(IPostRepository postRepository,  IAnimalRepository animalRepository, IAnimalService animalService, IClientService clientService)
    {
    ...
    {
        var dbPost = _postRepository.FetchAll();
