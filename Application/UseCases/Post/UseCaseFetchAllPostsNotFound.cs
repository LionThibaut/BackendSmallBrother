...
public class UseCaseFetchAllPostsNotFound : IUseCaseQuery<IEnumerable<DtoOutputPost>>
{
    ...
    public UseCaseFetchAllPostsNotFound(IPostRepository postRepository, IAnimalRepository animalRepository, IAnimalService animalService, IClientService clientService)
    {
    ...
    // FetchAll Posts of Animals lost with their Animals and Clients
    public IEnumerable<DtoOutputPost> Execute()
    {
        var dbPost = _postRepository.FetchAllNotFound();
